...
-- SELECT * FROM order_details ORDER BY price_per_unit DESC;

-- SELECT * FROM order_details ORDER BY city DESC, price_per_unit limit 5;

SELECT * FROM order_details ORDER BY city DESC, price_per_unit limit 5 OFFSET 5;       -- OFFSET skips 5 and limit set limit... 
